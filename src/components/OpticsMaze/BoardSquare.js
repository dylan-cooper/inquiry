  ...
  render() {
    ...
    switch (val) {
      ...
      case lightFilterStart:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="vertical" color="#f00" />
          </Movable>
        )
        break
      case lightFilterStart + 1:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="horizontal" color="#f00" />
          </Movable>
        )
        break
      case lightFilterStart + 2:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="vertical" color="#0f0" />
          </Movable>
        )
        break
      case lightFilterStart + 3:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="horizontal" color="#0f0" />
          </Movable>
        )
        break
      case lightFilterStart + 4:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="vertical" color="#00f" />
          </Movable>
        )
        break
      case lightFilterStart + 5:
        child = (
          <Movable x={x} y={y}>
            <LightFilter direction="horizontal" color="#00f" />
          </Movable>
        )
        break
    }
...
export default DropTarget([ItemTypes.MOVABLE, ItemTypes.INVENTORY], squareTarget, collect)(BoardSquare)